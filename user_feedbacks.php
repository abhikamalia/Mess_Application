...
<div class="w3-top">
  <div class="w3-row w3-padding w3-black">
    ...
    <div class="w3-col s3">
      <a href="admin.php#menu" class="w3-button w3-block w3-black">MENU</a>
    </div>
    <div class="w3-col s3">
      <a href="admin.php#where" class="w3-button w3-block w3-black">WHERE</a>
    </div>
    <div class="w3-col s3">

     	<a href="admin.php#discount" class="w3-button w3-block w3-black">ADD OFFER</a>
...
<!-- About Container -->
	<div class="w3-container" id="discount" style="padding-bottom:32px;">
        <div  class="w3-container w3-padding-48">
          <h4 class="w3-center"><span><strong>User Feedbacks</strong></span></h4>
            ...
            <?php
                ...
                <br>
                <li class="w3-text-grey w3-center"><strong><?php echo $row['name']; ?> : </strong><?php  echo $row['feedback']; ?></li><br>
            <?php
                }
            ?>
